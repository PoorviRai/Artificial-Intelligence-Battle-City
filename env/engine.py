...
from sprites.tank import TankSprite
from sprites.base import BaseSprite
from sprites.wall import WallSprite
from sprites.explosion import ExplosionSprite
from sprites.bullet import BulletSprite
from manager import ResourceManager
from maps import StageMap


class TankBattle(object):

    def __init__(self, render=False, speed=60, max_frames=100000, frame_skip=1,
                 seed=None, num_of_enemies=5, player1_human_control=True,
    ...
    def clone(self):
        ...
        return TankBattle(render=self.rd, speed=self.speed, max_frames=self.max_frames, frame_skip=self.frame_skip,
                          seed=seed, num_of_enemies=self.num_of_enemies, player1_human_control=self.player1_human_control,
